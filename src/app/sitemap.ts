...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/legalizacion-nave-industrial-torrelavega`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.85 },
    { url: `${baseUrl}/legalizacion-nave-industrial-santander`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.85 },
    { url: `${baseUrl}/auditoria-energetica-empresas-cantabria`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.85 },
